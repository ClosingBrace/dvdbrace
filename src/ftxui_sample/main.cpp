...
// configuration step. It creates a namespace called `dvdbrace`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", dvdbrace::cmake::project_name, dvdbrace::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", dvdbrace::cmake::project_version);
      return EXIT_SUCCESS;
    }
